...
use crate::{app_state::AppState, constants::icons};
...
impl ControllerInfoPanel {
    ...
    /// Draw time display
    fn draw_time_display(&mut self, ui: &mut egui::Ui, app_state: &mut AppState) {
        ...
        if ui
            ...
            .clicked()
        {
            app_state.ui_state.toggle_time_format();
        }
    }

    fn draw_screenshot_button(&mut self, ui: &mut egui::Ui, app_state: &mut AppState) {
    ...
    pub fn draw(&mut self, ui: &mut egui::Ui, app_state: &mut AppState) {
        ...
        // Time display
        self.draw_time_display(ui, app_state);

        // Screenshot button
        self.draw_screenshot_button(ui, app_state);
