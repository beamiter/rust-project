...
impl<C: Connection + Clone> X11ColorAllocator<C> {
    pub fn new(conn: C, colormap: Colormap) -> Self {
        Self { conn, colormap }
    }
}

impl<C: Connection + Clone + Send + 'static> ColorAllocator for X11ColorAllocator<C> {
